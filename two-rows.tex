...
\begin{document}
    ...
    \newcommand{\oneone}{friends are those}
    \newcommand{\onetwo}{}
    \newcommand{\onethree}{15252412130902..002512..0521160212}
    \newcommand{\twoone}{rare people who ask}
    \newcommand{\twotwo}{}
    \newcommand{\twothree}{25002512..191216190712..142116..000204}
    \newcommand{\threeone}{how you are and}
    \newcommand{\threetwo}{ }
    \newcommand{\threethree}{211614..201608..002512..001309}
    \newcommand{\fourone}{then wait for the}
    \newcommand{\fourtwo}{ }
    \newcommand{\fourthree}{05211213..14002405..151625..052112}
    \newcommand{\fiveone}{answer.}
    \newcommand{\fivetwo}{ }
    \newcommand{\fivethree}{001302141225.}
    \newcommand{\sixone}{ }
    \newcommand{\sixtwo}{ }
    \newcommand{\sixthree}{ }
    ...
    \newcommand{\makerow}[1]{\cell{\StrChar{#1}{1}}&\cell{\StrChar{#1}{2}}&\cell{\StrChar{#1}{3}}& \cell{\StrChar{#1}{4}}& \cell{\StrChar{#1}{5}}&\cell{\StrChar{#1}{6}}&\cell{\StrChar{#1}{7}}&\cell{\StrChar{#1}{8}}&\cell{\StrChar{#1}{9}}&\cell{\StrChar{#1}{10}}&\cell{\StrChar{#1}{11}}&\cell{\StrChar{#1}{12}}&\cell{\StrChar{#1}{13}}&\cell{\StrChar{#1}{14}}&\cell{\StrChar{#1}{15}}&\cell{\StrChar{#1}{16}}&\cell{\StrChar{#1}{17}}&\cell{\StrChar{#1}{18}}&\cell{\StrChar{#1}{19}}}
     ...
     \newcommand{\makestrip}[3]{
		{\small{\cipher { Cipher, }{ Key = }\key} \hfil}		
		\begin{tabular}{ |*{19}{c|}}
         		\hline
    			\makerow{{ }}\\ \hline
   			\makerow{{ }}\\ \hline
